import { SearchIcon, CodeIcon, RocketIcon } from 'lucide-react';

export const featuresData = [
    {
        icon: <SearchIcon className="w-6 h-6" />,
        title: 'Research & Strategy',
        desc: 'We dive deep into your goals, audience, and challenges to create a clear strategy that guides the entire project.'
    },
    {
        icon: <CodeIcon className="w-6 h-6" />,
        title: 'Design & Develop',
        desc: 'We deliver high-quality design and scalable development focused on performance, usability, and seamless user experiences.'
    },
    {
        icon: <RocketIcon className="w-6 h-6" />,
        title: 'Launch & Evolve',
        desc: 'We launch your product, optimize its performance, and continuously improve it to drive measurable growth.'
    }
];
